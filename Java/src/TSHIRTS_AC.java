...
// int[] ddy = {1,-1,0,0,1,-1,-1,1};
    ...
    void solve() throws Exception {
        ...
        while (T-- > 0) {
            ...
            adj = new boolean[100][10];
            for (int i = 0; i < n; ++i) {
                String[] inp = ns().split(" ");
                for (String x : inp) {
                    adj[Integer.parseInt(x) - 1][i] = true;
                }
...
// s is id of tshirt
    ...
    void run() throws Exception {
        is = INPUT.isEmpty() ? System.in : new FileInputStream(new File(INPUT));
